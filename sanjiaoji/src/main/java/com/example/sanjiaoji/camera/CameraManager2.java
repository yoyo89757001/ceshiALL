...
public class CameraManager2 implements CameraPreview2.CameraPreviewListener {
    ...
    private static Camera.Size getBestPreviewSize(Camera mCamera) {
        ...
        for (Camera.Size tmpSize : allSupportedSize) {
            ...
            //选分辨率比较高的
            if (tmpSize.width > tmpSize.height && (tmpSize.width > SettingVar.mHeight2 / 2 || tmpSize.height > SettingVar.mWidth2 / 2)) {
        ...
        final float propotion = SettingVar.mWidth2 >= SettingVar.mHeight2 ? (float) SettingVar.mWidth2 / (float) SettingVar.mHeight2 : (float) SettingVar.mHeight2 / (float) SettingVar.mWidth2;
            ...
            new AsyncTask<Object, Object, Object>() {
                ...
                protected Object doInBackground(Object... params) {
                    ...
                    try {
                        ...
                        Log.d("CameraManager2", e.getMessage()+"222222222");
...
//                        }
    ...
    public interface CameraListener {
        void onPictureTaken(CameraPreviewData2 cameraPreviewData);
    }
}
