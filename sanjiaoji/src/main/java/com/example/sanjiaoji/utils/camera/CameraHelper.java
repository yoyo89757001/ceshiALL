package com.example.sanjiaoji.utils.camera;
    ...
    public void start() {
        synchronized (this) {
            ...
            try {
                ...
                Log.d(TAG, "previewSize.height:" +mCamera.getParameters().getPreviewSize().width);
                Log.d(TAG, "previewSize.height:" +mCamera.getParameters().getPreviewSize().height);
                if (cameraListener != null) {
...
//        }
    ...
    public static final class Builder {
        ...
        public Builder previewSize(int w,int h) {
            this.w=w;
            this.h=h;
            return this;
        }
        ...
        public CameraHelper build() {
            return new CameraHelper(this,w,h);
        }
    }
