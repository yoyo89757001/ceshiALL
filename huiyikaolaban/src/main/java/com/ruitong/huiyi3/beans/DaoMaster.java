...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        BenDiMBbeanDao.createTable(db, ifNotExists);
        BenDiQianDaoDao.createTable(db, ifNotExists);
        BenDiRenShuBeanDao.createTable(db, ifNotExists);
        HuanYinYuBeanDao.createTable(db, ifNotExists);
        MBLeiXingBeanDao.createTable(db, ifNotExists);
        ...
        HuiYiIDDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        BaoCunBeanDao.dropTable(db, ifExists);
        BenDiMBbeanDao.dropTable(db, ifExists);
        BenDiQianDaoDao.dropTable(db, ifExists);
        BenDiRenShuBeanDao.dropTable(db, ifExists);
        HuanYinYuBeanDao.dropTable(db, ifExists);
        MBLeiXingBeanDao.dropTable(db, ifExists);
        ...
        HuiYiIDDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(BenDiMBbeanDao.class);
        registerDaoClass(BenDiQianDaoDao.class);
        registerDaoClass(BenDiRenShuBeanDao.class);
        registerDaoClass(HuanYinYuBeanDao.class);
        registerDaoClass(MBLeiXingBeanDao.class);
        ...
        registerDaoClass(HuiYiIDDao.class);
    }
