...
public class RandomDataUtil {
    ...
    /**
     * 生成随机集合（不重复）     * <p>     *     使用Set的值唯一的特性。     *
     * 最佳适用场合：集合中数目多，取相对较少对象时。在取对象相对较多时（超过集合的一半时）采用逆向方法，     *
     * 在取得对象个数是集合总数的1/2左右时是效率最慢的。     * </p>     * @param list
    ...
    /**
     * 生成随机集合，随机置换位置、随机截取位置法。     * <p>     *
     * 随机置换法：将集合的每个位置值与随机位置的值调换，并随机截取位置.
     * *     最佳适合场合：集合的数量相对较少，获取较多的随机个数集合。
     * * </p>     * @param list     * @param generateNum     * @param <T>     * @return
     */
    ...
    /**
     * 随机置换算法     * @param list     * @param generateNum     * @param <T>     * @return
     */
    ...
    /**
     * 随机生成截取位置     * @param totalCount     * @param generateNum     * @return
     */
    ...
    /**
     * 生成不重复的随机数     * @param totalCount     * @param generateNum     * @param     * @return
     */
    ...
    /**
     * 验证参数是否合法     * @param totalCount     * @param generateNum
     */
    ...
    /**
     * 判断使用哪种生成机制     * @param totalCount     * @param generateNum     * @return
     */
    ...
    /**
     * 生成set，不重复     * @param totalCount     * @param generateNum     * @return
     */
    ...
    /**
     * 逆向生成set，不重复     * @param totalCount     * @param generateNum     * @return
     */
