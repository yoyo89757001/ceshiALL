...
public class XiuGaiHouTaiDialog extends Dialog implements View.OnFocusChangeListener {
   // private TextView title2;
    ...
    private EditText ip,zhanghao,mima;
    ...
    private void setCustomDialog() {
        ...
        ip= (EditText) mView.findViewById(R.id.xiangce);
        mima= (EditText) mView.findViewById(R.id.xiangce2);
        zhanghao= (EditText) mView.findViewById(R.id.xiangce3);
