...
public class GongDiYanShiActivity extends Activity implements RecytviewCash {
    ...
    LinearLayout ll1;
    @BindView(R.id.ss1)
    HorizontalScrollView ss1;
    @BindView(R.id.ll2)
    LinearLayout ll2;
    @BindView(R.id.ss2)
    HorizontalScrollView ss2;
    ...
    private static Vector<Long> longVector = new Vector<>();
    private int dw, dh;
        ...
        public boolean handleMessage(final Message msg) {
            switch (msg.what) {
                ...
                case 1:
                    ...
                    BenDiQianDao benDiQianDao=benDiQianDaoDao.load(dataBean.getId());
                    if (benDiQianDao==null){
                        BenDiQianDao dao=new BenDiQianDao();
                        dao.setId(dataBean.getId());
                        benDiQianDaoDao.insert(dao);
                    ...
                    if (ll1.getChildCount() > 6) {
                        ll1.removeViewAt(ll1.getChildCount()-1);
                    }
                ...
                case 2:
                    ...
                    if (ll2.getChildCount() > 12) {
                        ll2.removeViewAt(ll2.getChildCount()-1);
                    }
